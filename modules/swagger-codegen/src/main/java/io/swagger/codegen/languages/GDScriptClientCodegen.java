...
import io.swagger.codegen.jcpp.CppTask;
...
public class GDScriptClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    protected String projectName; // for setup.gd, e.g. petstore-api
    protected String packageUrl;
    protected String apiDocPath = "";
    protected String modelFilename = "ModelApi";
    ...
    public GDScriptClientCodegen() {
        ...
        apiPackage = "api";
        outputFolder = "generated-code" + File.separatorChar + "gdscript";
    ...
    public void processOpts() {
        ...
        // make api doc path available in mustache template
    ...
    private static String dropDots(String str) { return str.replaceAll("\\.", "_"); }

    @Override
    public String toModelImport(String name) { return toModelFilename(name); }
    ...
    public Map<String, Object> postProcessOperationsWithModels(Map<String, Object> objs, List<Object> allModels) {
        // TODO: modify arguments list here ...
        return objs;
    }
    ...
    @Override
    public String getName() { return "gdscript"; }

    @Override
    public String getHelp() { return "Generates a GDScript client library."; }
    ...
    @Override
    public String apiDocFileFolder() { return (outputFolder + File.separatorChar + apiDocPath); }
    @Override
    public String toApiDocFilename(String name) { return toApiName(name); }
    @Override
    public String toModelDocFilename(String name) { return toApiName(name) + "DocModel"; }
    @Override
    public String apiFileFolder() { return outputFolder; }
    @Override
    public String modelFileFolder() { return outputFolder + File.separatorChar + modelFolder; }
    @Override
    public String apiTestFileFolder() { return outputFolder + File.separatorChar + testFolder; }
    @Override
    public String modelTestFileFolder() { return outputFolder + File.separatorChar + testFolder; }
    @Override
    public String modelDocFileFolder() { return outputFolder + File.separatorChar; }
    ...
    @Override
    public String toModelFilename(String name) { return underscore(dropDots(modelFilename)); }

    @Override
    public String toModelTestFilename(String name) { return "test_" + toModelFilename(name); }

    @Override
    public String toApiFilename(String name) { return toApiName(name); }
