...
public class BuildMetadata {
    ...
    private BuildMetadata() throws IOException {
        ...
        if (url == null) {
            properties.put("Implementation-Version", "0.0.1");
            properties.put("Build-Date", "2015-01-01_10:09:09");
            properties.put("Change", "0");
        } else {
    ...
    public SemVer getVersion() {
        return new SemVer(properties.getProperty("Implementation-Version"));
    }
