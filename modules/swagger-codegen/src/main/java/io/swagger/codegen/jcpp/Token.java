...
public final class Token {
    ...
    public static final int P_NL = 285;
    public static final int OR_EQ = 286;
    public static final int PASTE = 287;
    public static final int PLUS_EQ = 288;
    public static final int RANGE = 289;
    public static final int RSH = 290;
    public static final int RSH_EQ = 291;
    public static final int SQSTRING = 292;
    public static final int STRING = 293;
    public static final int SUB_EQ = 294;
    public static final int WHITESPACE = 295;
    public static final int XOR_EQ = 296;
    public static final int M_ARG = 297;
    public static final int M_PASTE = 298;
    public static final int M_STRING = 299;
    public static final int P_LINE = 300;
    public static final int INVALID = 301;
